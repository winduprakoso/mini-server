...
class TempOutprod extends Model
{
    use HasFactory;

    protected $table = 'temp_outprods';
    protected $primaryKey = 'id';
    protected $fillable = ["line_no","carline","id_cust","id_cv","cv","cv_loding","assy_no","std_box","nik","pic_prd","tgl_prd","shift","pm","waktu","serial_np","barcode_np","serial_box","barcode_box","gelombang","pic_prn","tgl_prn","pic_ver","tgl_ver","item_ver","barcode_awal","barcode_kbn"];
